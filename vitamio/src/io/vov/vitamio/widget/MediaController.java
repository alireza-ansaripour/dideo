  ...
  public void show(int timeout) {
    if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
      ...
      if (mFromXml) {
        ...
        int px = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 98, r.getDisplayMetrics());
        mWindow.showAtLocation(mAnchor, Gravity.NO_GRAVITY, 0,mAnchor.getHeight()-px);
      }
      mShowing = true;
    ...
    if (mShowing) {
      try {
        ...
        if (mFromXml) {
          ...
          android.util.Log.d("anchor view", "doing");
        }
        else {
          mWindow.dismiss();
          android.util.Log.d("anchor view", "doing2");
        }
